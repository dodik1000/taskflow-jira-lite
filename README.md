...
Дополнительно используются helper functions в базе данных для проверки:

- является ли пользователь owner доски
- является ли пользователь участником доски
- есть ли доступ к колонке
- есть ли доступ к задаче
...
- добавлены тесты компонентов, маршрутов и сервисов
...
- расширение тестов на auth-flow, services, roles, task modal и drag-and-drop reorder
